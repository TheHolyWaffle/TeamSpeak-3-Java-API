...
public class FileCommandsTest {
	...
	public void ftCreateDir_NullPathException() {
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftCreateDir(null, 1, null));
	}

	@Test
	public void ftCreateDir() {
		final String expected = "ftcreatedir cid=1 cpw= dirname=\\/dir1";
		assertEquals(expected, FileCommands.ftCreateDir("/dir1", 1, null).toString());
		assertEquals(expected, FileCommands.ftCreateDir("dir1", 1, null).toString());
	}
	...
	public void ftDeleteFile_EmptyFileArrayException() {
		...
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftDeleteFile(1, null, filePaths));
	}

	@Test
	public void ftDeleteFile_NullFileArrayException() {
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftDeleteFile(1, null, (String[]) null));
	}
	...
	public void ftDeleteFile() {
		...
		assertEquals(expected, FileCommands.ftDeleteFile(1, null, filePaths).toString());
	}

	@Test
	public void ftGetFileInfo_EmptyFileArrayException() {
		final String[] filePaths = {};
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftGetFileInfo(1, null, filePaths));
	}

	@Test
	public void ftGetFileInfo_NullFileArrayException() {
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftGetFileInfo(1, null, (String[]) null));
	}
	...
	public void ftGetFileInfo() {
		...
		assertEquals(expected, FileCommands.ftGetFileInfo(1, null, filePaths).toString());
	}

	@Test
	public void ftGetFileInfoArray_EmptyChannelIDArrayException() {
		final int[] channelIds = {};
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftGetFileInfo(channelIds, null, null));
	}

	@Test
	public void ftGetFileInfoArray_NullChannelIDArrayException() {
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftGetFileInfo(null, null, null));
	}
	...
	public void ftGetFileInfoArray_EmptyFileArrayException() {
		...
		final String[] filePaths = {};
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftGetFileInfo(channelIds, null, filePaths));
	}
	...
	public void ftGetFileInfoArray_PasswordsLengthFilePathsLengthException() {
		...
		final String[] filePaths = {"dir1", "dir2"};
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftGetFileInfo(channelIds, channelPasswords, filePaths));
	}
	...
	public void ftGetFileInfoArray() {
		...
		assertEquals(expected, FileCommands.ftGetFileInfo(channelIds, channelPasswords, filePaths).toString());
	}

	@Test
	public void ftGetFileList_NullDirectoryPathException() {
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftGetFileList(null, 1, null));
	}

	@Test
	public void ftGetFileList() {
		final String expected = "ftgetfilelist cid=1 cpw= path=\\/dir1\\/";
		assertEquals(expected, FileCommands.ftGetFileList("/dir1", 1, null).toString());
		assertEquals(expected, FileCommands.ftGetFileList("dir1/", 1, null).toString());
	}

	@Test
	public void ftInitDownload_NullDirectoryPathException() {
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftInitDownload(1, null, 1, null));
	}

	@Test
	public void ftInitDownload() {
		final String expected = "ftinitdownload clientftfid=1 name=\\/dir1 cid=1 cpw= seekpos=0 proto=0";
		assertEquals(expected, FileCommands.ftInitDownload(1, "/dir1", 1, null).toString());
		assertEquals(expected, FileCommands.ftInitDownload(1, "dir1", 1, null).toString());
	}

	@Test
	public void ftInitUpload_NullDirectoryPathException() {
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftInitUpload(1, null, 1, null, 1024, true));
	}
	...
	public void ftInitUpload() {
		...
		assertEquals(expected, FileCommands.ftInitUpload(1, "/dir1", 1, null, 1024, true).toString());
		assertEquals(expected, FileCommands.ftInitUpload(1, "dir1", 1, null, 1024, true).toString());
	}
	...
	public void ftList() {
		...
		assertEquals(expected, FileCommands.ftList().toString());
	}

	@Test
	public void ftRenameFile_NullOldPathException() {
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftRenameFile(null, "dir2", 1, null));
	}

	@Test
	public void ftRenameFile_NullNewPathException() {
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftRenameFile("dir1", null, 1, null));
	}

	@Test
	public void ftRenameFile() {
		final String expected = "ftrenamefile cid=1 cpw= oldname=\\/dir1 newname=\\/dir2";
		assertEquals(expected, FileCommands.ftRenameFile("/dir1", "dir2", 1, null).toString());
		assertEquals(expected, FileCommands.ftRenameFile("dir1", "/dir2", 1, null).toString());
	}

	@Test
	public void ftRenameFileAndChannel_NullOldPathException() {
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftRenameFile(null, "dir2", 1, null, 2, null));
	}

	@Test
	public void ftRenameFileAndChannel_NullNewPathException() {
		assertThrows(IllegalArgumentException.class, () -> FileCommands.ftRenameFile("dir1", null, 1, null, 2, null));
	}

	@Test
	public void ftRenameFileAndChannel() {
		final String expected = "ftrenamefile cid=1 cpw= tcid=2 tcpw= oldname=\\/dir1 newname=\\/dir2";
		assertEquals(expected, FileCommands.ftRenameFile("/dir1", "dir2", 1, null, 2, null).toString());
		assertEquals(expected, FileCommands.ftRenameFile("dir1", "/dir2", 1, null, 2, null).toString());
	}
}
